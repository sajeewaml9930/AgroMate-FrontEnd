...
class AgriOfficer_2_Reseller extends StatefulWidget {
  final int ResellerId;

  const AgriOfficer_2_Reseller({super.key, required this.ResellerId});

  @override
  // ignore: library_private_types_in_public_api
  _AgriOfficer_2_ResellerState createState() => _AgriOfficer_2_ResellerState();
}

class _AgriOfficer_2_ResellerState extends State<AgriOfficer_2_Reseller> {
